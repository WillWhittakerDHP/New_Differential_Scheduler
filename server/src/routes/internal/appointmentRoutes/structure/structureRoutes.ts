...
// // ORIGINAL GET AdditionalServicesByServiceID
// router.get('/ao/:id', async (req: Request, res: Response) => {
//   const { id } = req.params;
//   try {
//     console.log('Start AdditionalServiceByServiceID');
//     const AdditionalServiceByServiceID = await Service.findByPk(id,{
//       include: [{ 
...
//       }],
//     });
//     if (AdditionalServiceByServiceID) {
//       console.log('AdditionalServiceByServiceID result:', AdditionalServiceByServiceID);
//       res.json(AdditionalServiceByServiceID);
//     } else {
